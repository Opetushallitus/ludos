...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.33.8")
    implementation("software.amazon.awssdk:s3:2.33.8")
    implementation("software.amazon.awssdk:sso:2.33.8")
    implementation("software.amazon.awssdk:ssooidc:2.33.8")
