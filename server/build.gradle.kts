...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.55.4")
    implementation("software.amazon.awssdk:s3:2.55.4")
    implementation("software.amazon.awssdk:sso:2.55.4")
    implementation("software.amazon.awssdk:ssooidc:2.55.4")
