...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.27.9")
    implementation("software.amazon.awssdk:s3:2.27.9")
    implementation("software.amazon.awssdk:sso:2.27.9")
    implementation("software.amazon.awssdk:ssooidc:2.27.9")
    implementation("org.springframework.security:spring-security-cas:6.3.2")
