...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.47.3")
    implementation("software.amazon.awssdk:s3:2.47.3")
    implementation("software.amazon.awssdk:sso:2.47.3")
    implementation("software.amazon.awssdk:ssooidc:2.47.3")
