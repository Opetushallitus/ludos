...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.32.18")
    implementation("software.amazon.awssdk:s3:2.32.18")
    implementation("software.amazon.awssdk:sso:2.32.18")
    implementation("software.amazon.awssdk:ssooidc:2.32.18")
    implementation("org.springframework.security:spring-security-cas:6.5.2")
    implementation("org.springframework:spring-test:6.2.9")
