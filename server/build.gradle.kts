...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.34.6")
    implementation("software.amazon.awssdk:s3:2.34.6")
    implementation("software.amazon.awssdk:sso:2.34.6")
    implementation("software.amazon.awssdk:ssooidc:2.34.6")
