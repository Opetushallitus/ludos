...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.29.12")
    implementation("software.amazon.awssdk:s3:2.29.11")
    implementation("software.amazon.awssdk:sso:2.29.11")
    implementation("software.amazon.awssdk:ssooidc:2.29.11")
    implementation("org.springframework.security:spring-security-cas:6.3.4")
    implementation("org.springframework:spring-test:6.1.14")
