...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.31.17")
    implementation("software.amazon.awssdk:s3:2.31.17")
    implementation("software.amazon.awssdk:sso:2.31.17")
    implementation("software.amazon.awssdk:ssooidc:2.31.17")
