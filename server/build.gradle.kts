...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.28.23")
    implementation("software.amazon.awssdk:s3:2.28.24")
    implementation("software.amazon.awssdk:sso:2.28.23")
    implementation("software.amazon.awssdk:ssooidc:2.28.23")
