...
dependencies {
    ...
    implementation("ch.qos.logback.access:logback-access-common:2.0.9")
    implementation("net.logstash.logback:logstash-logback-encoder:8.1")
    implementation("ch.qos.logback.access:logback-access-tomcat:2.0.9")
    implementation("org.jetbrains.kotlin:kotlin-reflect:2.3.0")
    implementation("org.jsoup:jsoup:1.22.1")
    implementation("software.amazon.awssdk:cloudwatchlogs:2.41.19")
    implementation("software.amazon.awssdk:s3:2.41.19")
    implementation("software.amazon.awssdk:sso:2.41.19")
    implementation("software.amazon.awssdk:ssooidc:2.41.19")
