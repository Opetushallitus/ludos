...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.28.13")
    implementation("software.amazon.awssdk:s3:2.28.12")
    implementation("software.amazon.awssdk:sso:2.28.12")
    implementation("software.amazon.awssdk:ssooidc:2.28.13")
