...
dependencies {
    ...
    implementation("ch.qos.logback:logback-access:1.5.9")
    implementation("net.logstash.logback:logstash-logback-encoder:7.4")
    implementation("org.flywaydb:flyway-core:10.19.0")
    implementation("org.flywaydb:flyway-database-postgresql:10.19.0")
    implementation("org.jetbrains.kotlin:kotlin-reflect:2.0.21")
    implementation("org.jsoup:jsoup:1.18.1")
    implementation("software.amazon.awssdk:cloudwatchlogs:2.28.20")
    implementation("software.amazon.awssdk:s3:2.28.19")
    implementation("software.amazon.awssdk:sso:2.28.19")
    implementation("software.amazon.awssdk:ssooidc:2.28.19")
