...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.46.12")
    implementation("software.amazon.awssdk:s3:2.46.12")
    implementation("software.amazon.awssdk:sso:2.46.12")
    implementation("software.amazon.awssdk:ssooidc:2.46.12")
