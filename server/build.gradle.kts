...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.29.41")
    implementation("software.amazon.awssdk:s3:2.29.41")
    implementation("software.amazon.awssdk:sso:2.29.40")
    implementation("software.amazon.awssdk:ssooidc:2.29.41")
