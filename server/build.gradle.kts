...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.53.1")
    implementation("software.amazon.awssdk:s3:2.53.1")
    implementation("software.amazon.awssdk:sso:2.53.1")
    implementation("software.amazon.awssdk:ssooidc:2.53.1")
