...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.30.1")
    implementation("software.amazon.awssdk:s3:2.30.1")
    implementation("software.amazon.awssdk:sso:2.30.1")
    implementation("software.amazon.awssdk:ssooidc:2.30.1")
