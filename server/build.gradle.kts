...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("org.bouncycastle:bcprov-jdk15on"))
            .using(module("org.bouncycastle:bcprov-jdk18on:1.86"))
        ...
        substitute(module("org.bouncycastle:bcutil-jdk15on"))
            .using(module("org.bouncycastle:bcutil-jdk18on:1.86"))
    }
}
...
dependencies {
    ...
    implementation("ch.qos.logback.access:logback-access-common:2.0.15")
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.54.20")
    implementation("software.amazon.awssdk:s3:2.54.20")
    implementation("software.amazon.awssdk:sso:2.54.20")
    implementation("software.amazon.awssdk:ssooidc:2.54.20")
