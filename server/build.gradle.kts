...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.29.10")
    implementation("software.amazon.awssdk:s3:2.29.11")
    implementation("software.amazon.awssdk:sso:2.29.10")
    implementation("software.amazon.awssdk:ssooidc:2.29.10")
