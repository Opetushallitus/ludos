...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.54.9")
    implementation("software.amazon.awssdk:s3:2.54.9")
    implementation("software.amazon.awssdk:sso:2.54.9")
    implementation("software.amazon.awssdk:ssooidc:2.54.9")
