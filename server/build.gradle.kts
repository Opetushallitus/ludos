...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.51.0")
    implementation("software.amazon.awssdk:s3:2.51.0")
    implementation("software.amazon.awssdk:sso:2.51.0")
    implementation("software.amazon.awssdk:ssooidc:2.51.0")
