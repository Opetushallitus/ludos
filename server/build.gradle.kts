...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.28.10")
    implementation("software.amazon.awssdk:s3:2.28.10")
    implementation("software.amazon.awssdk:sso:2.28.10")
