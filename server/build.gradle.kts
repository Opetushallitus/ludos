...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.53.2")
    implementation("software.amazon.awssdk:s3:2.53.2")
    implementation("software.amazon.awssdk:sso:2.53.2")
    implementation("software.amazon.awssdk:ssooidc:2.53.2")
