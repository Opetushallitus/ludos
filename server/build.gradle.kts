...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.35.4")
    implementation("software.amazon.awssdk:s3:2.35.4")
    implementation("software.amazon.awssdk:sso:2.35.4")
    implementation("software.amazon.awssdk:ssooidc:2.35.4")
