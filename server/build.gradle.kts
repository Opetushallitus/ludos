...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.33.10")
    implementation("software.amazon.awssdk:s3:2.33.10")
    implementation("software.amazon.awssdk:sso:2.33.10")
    implementation("software.amazon.awssdk:ssooidc:2.33.10")
    implementation("org.springframework.security:spring-security-cas:6.5.4")
