...
dependencies {
    ...
    implementation("software.amazon.awssdk:s3:2.26.30")
    implementation("software.amazon.awssdk:sso:2.26.30")
    implementation("software.amazon.awssdk:ssooidc:2.26.30")
