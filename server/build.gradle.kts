...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.30.37")
    implementation("software.amazon.awssdk:s3:2.30.37")
    implementation("software.amazon.awssdk:sso:2.30.37")
    implementation("software.amazon.awssdk:ssooidc:2.30.37")
    implementation("org.springframework.security:spring-security-cas:6.4.3")
    implementation("org.springframework:spring-test:6.2.4")
