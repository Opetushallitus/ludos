...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.45.1")
    implementation("software.amazon.awssdk:s3:2.45.1")
    implementation("software.amazon.awssdk:sso:2.45.1")
    implementation("software.amazon.awssdk:ssooidc:2.45.1")
