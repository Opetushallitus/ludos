...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.26.28")
    implementation("software.amazon.awssdk:s3:2.26.28")
    implementation("software.amazon.awssdk:sso:2.26.28")
    implementation("software.amazon.awssdk:ssooidc:2.26.28")
