...
dependencies {
    ...
    implementation("software.amazon.awssdk:cloudwatchlogs:2.35.0")
    implementation("software.amazon.awssdk:s3:2.35.0")
    implementation("software.amazon.awssdk:sso:2.35.0")
    implementation("software.amazon.awssdk:ssooidc:2.35.0")
