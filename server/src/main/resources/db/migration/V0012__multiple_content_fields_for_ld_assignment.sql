...
(
    ...
    assignment_content_assignment_id      integer REFERENCES assignment (assignment_id),
    assignment_content_language           language,
    assignment_content_assignment_content text    NOT NULL,
    assignment_order_index                integer NOT NULL,
    CONSTRAINT assignment_content_assignment_id_content_language_unique UNIQUE (assignment_content_assignment_id, assignment_content_language)
);
...
(
    ...
    CONSTRAINT suko_assignment_content_assignment_content_assignment_id_fkey FOREIGN KEY (assignment_content_assignment_id)
...
-- Migrate contentFi
INSERT INTO suko_assignment_content (assignment_content_assignment_id, assignment_content_language,
                                     assignment_content_assignment_content, assignment_order_index)
...
(
    PRIMARY KEY (assignment_content_content_id),
    CONSTRAINT ld_assignment_content_assignment_content_assignment_id_fkey FOREIGN KEY (assignment_content_assignment_id)
...
-- Migrate contentFi
INSERT INTO ld_assignment_content (assignment_content_assignment_id, assignment_content_language,
                                   assignment_content_assignment_content, assignment_order_index)
SELECT a.assignment_id, 'FI', a.assignment_content_fi, 0
...
(
    PRIMARY KEY (assignment_content_content_id),
    CONSTRAINT puhvi_assignment_content_assignment_content_assignment_id_fkey FOREIGN KEY (assignment_content_assignment_id)
...
-- Migrate contentFi
INSERT INTO puhvi_assignment_content (assignment_content_assignment_id, assignment_content_language,
                                      assignment_content_assignment_content, assignment_order_index)
SELECT a.assignment_id, 'FI', a.assignment_content_fi, 0
